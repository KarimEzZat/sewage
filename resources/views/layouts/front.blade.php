...
<head>
    ...
    <meta name="author" content="شركة وايت الرياض - تسليك المجاري ووايت شفط صرف صحي بجميع احياء الرياض حيث تعتبر خدمة شفط صرف صحي أمرًا ضروريًا للحفاظ على نظافة وصحة منزلك">
    <!-- Meta Description -->
    <meta name="description"
          content="شركة وايت الرياض - تسليك المجاري ووايت شفط صرف صحي بجميع احياء الرياض حيث تعتبر خدمة شفط صرف صحي أمرًا ضروريًا للحفاظ على نظافة وصحة منزلك">
    <meta property="og:title" content="شركة وايت الرياض لتسليك المجاري ووايت شفط صرف صحي بجميع احياء الرياض حيث تعتبر خدمة شفط صرف صحي أمرًا ضروريًا للحفاظ على نظافة وصحة منزلك"/>
    <meta property="og:description"
          content="شركة وايت الرياض - تسليك المجاري ووايت شفط صرف صحي بجميع احياء الرياض حيث تعتبر خدمة شفط صرف صحي أمرًا ضروريًا للحفاظ على نظافة وصحة منزلك"/>
    <meta property="og:url" content="{{ route('welcome') }}"/>
    <meta property="og:image"
          content="{{asset('assets/Images/'.$companies->first()->photo)}}">
    <meta property="og:site_name" content="شركة وايت الرياض شركة وايت شفط صرف صحي وتسليك مجاري"/>
    <meta property="og:image:secure_url" content="{{asset('assets/Images/'.$companies->first()->photo)}}"/>


    <meta property="og:image:alt" content="شركة وايت شركة وايت شفط صرف صحي وتسليك مجاري"/>
    <meta name="twitter:card" content="summary_large_image"/>
    <meta name="twitter:title" content="شركة وايت الرياض شركة وايت شفط صرف صحي وتسليك مجاري"/>
    <meta name="twitter:description"
          content="شركة وايت الرياض - شركة وايت شفط صرف صحي وتسليك مجاري"/>
    ...
    <div class="container py-3">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="whats-btn d-flex">
                ...
                <!--    <i class="fa fa-map-marker ml-2" style="color: #d98d59"></i>-->
                <!--    <p class="mb-0">-->
                ...
                <div class="footer-top flex-column">
                    <div class="footer-logo text-center">
                        <a href="{{ route('welcome') }}">
                            <img src="{{ asset('public/front-end/assets/img/footer-logo.png') }}" alt="شركة وايت الرياض - وايت صرف صحي وتسليك مجاري">
                        </a>
                        <h4>تواصل معنا</h4>
                    </div>
...
<div class="fixed-btn">
    ...
    <a href="tel:+966549362523" class="ms-call-button">
      ...
      <svg width="45" height="65" fill="#d98d59" role="img" focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 512 512">
